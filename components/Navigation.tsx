            ...
            <div className="hidden lg:flex items-center space-x-2">
              <Link
                ...
                className={`px-4 py-2 font-manrope text-sm font-medium transition-colors relative group ${
                  isScrolled ? 'text-dark-carbon/80 hover:text-dark-carbon' : 'text-white/80 hover:text-white'
                }`}
              >
                Ana Sayfa
                ...
                <AnimatePresence>
                  {activeMegaMenu === 'hizmetler' && (
                    <motion.div
                      ...
                      className="absolute left-0 top-full mt-2 w-[600px] bg-white/98 backdrop-blur-xl rounded-lg shadow-2xl border-2 border-muted-gold/20 overflow-hidden"
                    >
              ...
              <button className={`p-2 rounded-lg transition-all ${
                isScrolled ? 'text-dark-carbon/60 hover:text-dark-carbon hover:bg-dark-carbon/5' : 'text-white/60 hover:text-white hover:bg-white/10'
              }`}>
